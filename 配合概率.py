...
count6=0
a=12
k=input("enter the length you have and the probability of getting a 8-card fit will be shown (do not enter invalid number becuase that only hurts your own computer):")
j=int(k)
p=8-j
while x<100000:
    global card
