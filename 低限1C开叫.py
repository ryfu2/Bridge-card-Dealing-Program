...
oR=100*w/count
count=aH+aS+aD+aC
print("Statistics of a minimum natural 1C opening(3+C with 12-14 balanced or 11-14 unbalnced, ignore 12P 4333):")
print("The probability of having a 1C opening when hold a minimum:",oR,"%")
