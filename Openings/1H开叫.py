...
oR=100*w/count
count=aH+aS+aD+aC
print("Statistics of a natural 1H opening(12-21 5+H):")
print("The probability of a 1H opening:",oR,"%")
...
print("The probability of getting 5 hearts:",aC5,"%")
print("The probability of getting more than 5 hearts:",aC6,"%")
